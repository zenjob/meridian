...
class Calibra:
  ...
  def _get_roi_prior_beta_m_value(
    ...
    incsales_m = roi_m * tf.reduce_sum(
    ...
    if self.media_effects_dist == constants.MEDIA_EFFECTS_NORMAL:
      ...
      return (incsales_m - random_effect_m) / media_contrib_m
    else:
      ...
      return tf.math.log(incsales_m) - tf.math.log(random_effect_m)
  ...
  def _get_roi_prior_beta_rf_value(
    ...
    incsales_rf = roi_rf * tf.reduce_sum(
    ...
    if self.media_effects_dist == constants.MEDIA_EFFECTS_NORMAL:
      ...
      return (incsales_rf - random_effect_rf) / media_contrib_rf
    else:
      ...
      return tf.math.log(incsales_rf) - tf.math.log(random_effect_rf)
...
def save_mmm(mmm: Calibra, file_path: str):
...
def load_mmm(file_path: str) -> Calibra:
